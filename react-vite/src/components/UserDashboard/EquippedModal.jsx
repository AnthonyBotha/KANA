...
import "../Inventory/ItemModal.css"

const ManageEquippedModal = ({ itemId, itemName, itemImage, itemDescription, itemValue,equipped }) => {
    ...
    const handleEquip = async () => {
        ...
        if (result) {
            ...
            setMessage(`${itemName} Unequipped Sucessfully.`);
            ...
            {!message ? (
                <>
                    ...
                    <div className="item-action-buttons">
                        <span><button className="small-button" onClick={handleEquip}>Unmount</button></span>
...
export default ManageEquippedModal;
